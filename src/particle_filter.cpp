...
//using std::vector;
using namespace std;
// declare a random engine to be used across
// multiple and various method calls for generation random data
...
void ParticleFilter::prediction(double delta_t, double std_pos[],
    ...
    for (int i = 0; i < num_particles; i++) {
        ...
        // calculate new state
        // if condition reduces computation
...
void ParticleFilter::resample() {
    ...
    // generate random starting index for re-sampling step
